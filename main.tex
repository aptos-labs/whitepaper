...
\begin{comment}
https://www.overleaf.com/project/62cd692e2c2418ea46faba62
...
* Differentiate our approach from other competitors in the web3 space
Provide the appropriate level of detail - especially for future work (more detail on areas we have more information and more directional on areas we still need to do research/eng).  We will not lock ourselves into any irreversible changes.
Terminology
...
Formatting
* After end{list}, start the next sentence immediately so the indent is far to the left for looks
...
%Furthermore, the ability to rotate the keys may require that the account be dormant for a certain period of time. In this case, the user may delegate this ability to a cold wallet.
